...
const copy: Record<AppLocale, PublicCopy> = {
  ...
  fr: {
    ...
    common: { parent: "Entreprise logicielle indépendante", available: "Disponible", soon: "Bientôt", development: "En développement", learn: "En savoir plus", view: "Voir", back: "Retour", individual: "Produit individuel", bundle: "Offre groupée", project: "Projet indépendant", perMonth: "/ mois", skip: "Aller au contenu", catalogMath: "Calcul du catalogue", availability: "Disponibilité", categories: { Acquire: "Acquérir", Schedule: "Planifier", Convert: "Convertir", Collect: "Encaisser", Retain: "Fidéliser", Reputation: "Réputation" } },
  ...
  nl: {
    ...
    stack: { ...en.stack, title: "Zes gelijkwaardige producten. Eén bundel.", body: "AYV Automation Stack bundelt alle zes producten. Elk blijft los beschikbaar.", math: "€534 catalogustotaal → €267 met 50% getoonde korting", truth: "De bundelprijs is ter planning. Er is vandaag geen aparte Stripe-bundelcheckout; beschikbare abonnementen worden los gekocht.", connected: "Verbonden workflowwaarde", connectedBody: "Start met één product, voeg later toe en houd de klantreis verbonden.", cta: "Start met een beschikbaar product" },
