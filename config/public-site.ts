...
const en = {
  ...
  ecosystem: {
    eyebrow: "AYV WRLD / Ecosystem",
    title: "Explore the AYV WRLD ecosystem.",
    body: "AYV WRLD sits at the center. Products, projects, and systems connect around it.",
    ...
    ecosystemType: "Product ecosystem",
    stackHint: "Six products form one Automation Stack."
  },
  stack: {
...
const copy: Record<AppLocale, PublicCopy> = {
  ...
  fr: {
    ...
    ecosystem: { ...en.ecosystem, title: "Explorez l’écosystème AYV WRLD.", body: "AYV WRLD est au centre. Produits, projets et systèmes se connectent autour.", back: "Retour à l’écosystème", readMore: "En savoir plus", description: "Description", does: "Ce que cela fait", problem: "Problème résolu", parent: "Société mère", ecosystemType: "Écosystème produit", stackHint: "Six produits forment un Automation Stack." },
  ...
  de: {
    ...
    ecosystem: { ...en.ecosystem, title: "Das AYV WRLD Ökosystem erkunden.", body: "AYV WRLD steht im Zentrum. Produkte, Projekte und Systeme verbinden sich darum.", back: "Zurück zum Ökosystem", readMore: "Weiterlesen", description: "Beschreibung", does: "Was es tut", problem: "Welches Problem es löst", parent: "Muttermarke", ecosystemType: "Produktökosystem", stackHint: "Sechs Produkte bilden einen Automation Stack." },
  ...
  nl: {
    ...
    ecosystem: { ...en.ecosystem, title: "Verken het AYV WRLD-ecosysteem.", body: "AYV WRLD staat in het midden. Producten, projecten en systemen verbinden zich eromheen.", back: "Terug naar het ecosysteem", readMore: "Lees meer", description: "Beschrijving", does: "Wat het doet", problem: "Welk probleem het oplost", parent: "Moedermerk", ecosystemType: "Productecosysteem", stackHint: "Zes producten vormen één Automation Stack." },
